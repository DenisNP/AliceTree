module.exports.colorCodes = [
    ...
    [['антрацит'], '464451'],
    [['бежев'], 'f5f5dc'],
    [['белый', 'белого', 'белую', 'белая', 'белой', 'белым', 'белые'], 'ffffff'],
    [['бирюзов'], '00ffff'],
    [['бордо'], '9b2d30'],
    [['бронзов'], 'cd7f32'],
    ...
    [['пурпурн'], '800080'],
    [['розов'], 'ffc0cb'],
    [['рыжий', 'рыжего', 'рыжая', 'рыжей', 'рыжую', 'рыжим', 'рыжие'], 'd77d31'],
    [['салат'], '99ff99'],
    [['сапфир'], '082567'],
    [['серебр'], 'c0c0c0'],
    [['синий', 'синего', 'синяя', 'синюю', 'синей', 'синим', 'синие', 'синее'], '0000ff'],
    [['сиренев'], 'ff00ff'],
    [['скарлет'], 'fc2847'],
    [['сливов'], '660066'],
    [['терракот'], 'cc4e5c'],
